        ...
        <>
            <div className="lg:mx-[140px] dis mt-10 cursor-pointer ">
                <div className="flex justify-center items-center flex-row-reverse">
                    <p className="text-sm lg:text-xl lg:font-bold">داغ ترین چند ساعت گذشته</p>
                ...
                <div className=" flex flex-col h-80 flex-wrap ">
                    {data.map((item)=>(
                        ...
                        <div className=" flex items-center justify-end h-[95px]  text-right ">
                            ...
                            <p className="overflow-hidden w-80 border-b h-full items-center flex text-[10px] lg:text-xs">{item.decr}</p>
                        </div>
                    ))}
                </div>
                </ScrollContainer>
